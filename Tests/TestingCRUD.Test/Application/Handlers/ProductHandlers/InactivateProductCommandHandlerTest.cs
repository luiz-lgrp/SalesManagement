...
public class InactivateProductCommandHandlerTest
{
    private Mock<IProductRepository> _productRepositoryMock;
    private Mock<IProductReadRepository> _productReadRepositoryMock;

    public InactivateProductCommandHandlerTest()
    {
    ...
    [Fact]
    public async Task Handle_ValidCommand_ReturnsTrueAndProductStatusIsInactive()
    {
        //Arrange
        ...
        var requestComand = new InactivateProductCommand(product.Id);

        var handler = new InactivateProductCommandHandler(_productRepositoryMock.Object, _productReadRepositoryMock.Object);
        ...
        //Assert
        result.ShouldBeTrue();
        product.Status.ShouldBe(EntityStatus.Inactive);
    }
    ...
    public async Task Handle_ProductNotFound_ReturnsFalse()
    {
        ...
        var requestComand = new InactivateProductCommand(Guid.Parse("35eaf68d-0420-4e28-aeee-27d97ad6b6ab"));
    ...
    public async Task Handle_ValidCommand_SaveChangeAsyncIsCalledOnce()
    {
        ...
        var requestCommand = new InactivateProductCommand(product.Id);
