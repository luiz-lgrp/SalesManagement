...
{
    public class ExchangeStatusConcludeCommandHandlerTest
    {
        private Mock<IOrderRepository> _orderRepositoryMock;
        private Mock<IOrderReadRepository> _orderReadRepositoryMock;

        public ExchangeStatusConcludeCommandHandlerTest()
        {
        ...
        [Fact]
        public async Task Handle_OrderFound_StatusChangedToConclude_ReturnsTrue()
        {
            //Arrange
            ...
            var handler = new ExchangeStatusConcludeCommandHandler(_orderRepositoryMock.Object, _orderReadRepositoryMock.Object);

            var command = new ExchangeStatusConcludeCommand(orderId);
            ...
            // Assert
            result.ShouldBeTrue();
            order.Status.ShouldBe(OrderStatus.Concluded);
